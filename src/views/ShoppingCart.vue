                                    ...
                                    <tbody>
                                        <tr>
                                            <td class="cart-pic first-row">
                                                <img src="img/cart-page/pomade-1.jpg" />
                                            </td>
                                            <td class="cart-title first-row text-center">
                                                <h5>American Crew Pomade</h5>
                                            </td>
                                            <td class="p-price first-row">$90.00</td>
                                        ...
                                        <tr>
                                            <td class="cart-pic first-row">
                                                <img src="img/cart-page/sisir-3.jpg" />
                                            </td>
                                            <td class="cart-title first-row text-center">
                                                <h5>Sisir Mini Stainless Steel</h5>
                                            </td>
                                            <td class="p-price first-row">$25.00</td>
                                            <td class="delete-item"><a href="#"><i class="material-icons">
                                              close
                                              </i></a></td>
                                        </tr>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="proceed-checkout text-left">
                                <ul>
                                    <li class="subtotal">ID Transaction <span>#PN12000</span></li>
                                    <li class="subtotal mt-3">Subtotal <span>$115.00</span></li>
                                    <li class="subtotal mt-3">Pajak <span>10%</span></li>
                                    <li class="subtotal mt-3">Total Biaya <span>$126.50</span></li>
                                    <li class="subtotal mt-3">Bank Transfer <span>Mandiri</span></li>
                                    <li class="subtotal mt-3">No. Rekening <span>2208 1996 1403</span></li>
                                    <li class="subtotal mt-3">Nama Penerima <span>Pangkasnesia</span></li>
                                </ul>
